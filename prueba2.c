...
/*   Updated: 2024/04/13 19:01:34 by igvisera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			fd3 = open(FILE_NAME, O_WRONLY);//abrimos el archivo .txt
// 			dup2(fd3,STDIN_FILENO);//redirecccionamos la respuesta del comando al archivo .txt
// 			close(fd1[READ_END]);
// 			execlp("/bin/grep","grep", "u",NULL);
// 		}
// 		else /* padre */
...
// 			// fd3 = open(FILE_NAME, O_WRONLY);//abrimos el archivo .txt
// 			// dup2(fd3,
				//fd1[READ_END]);//redirecccionamos la respuesta del comando al archivo .txt
